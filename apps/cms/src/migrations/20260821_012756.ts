...
export async function down({ db }: MigrateDownArgs): Promise<void> {
  await db.execute(sql`
   DROP TABLE "cms"."rooms_artax_category_ids" CASCADE;
  DROP TABLE "cms"."rooms_gallery" CASCADE;
  DROP TABLE "cms"."rooms_amenities" CASCADE;
  DROP TABLE "cms"."rooms" CASCADE;
  DROP TABLE "cms"."rooms_locales" CASCADE;
  DROP TABLE "cms"."experiences_gallery" CASCADE;
  DROP TABLE "cms"."experiences" CASCADE;
  DROP TABLE "cms"."experiences_locales" CASCADE;
  DROP TABLE "cms"."gallery" CASCADE;
  DROP TABLE "cms"."gallery_locales" CASCADE;
  DROP TABLE "cms"."pages" CASCADE;
  DROP TABLE "cms"."pages_locales" CASCADE;
  DROP TABLE "cms"."blog_posts_tags" CASCADE;
  ...
  DROP TABLE "cms"."settings_locales" CASCADE;
  DROP TYPE "cms"."_locales";
  DROP TYPE "cms"."enum_rooms_status";
  DROP TYPE "cms"."enum_experiences_status";
  DROP TYPE "cms"."enum_experiences_category";
