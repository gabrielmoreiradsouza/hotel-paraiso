        ...
        <div className="flex flex-col md:flex-row justify-between gap-12">
          ...
          <div className="max-w-sm">
            ...
            <div className="mt-6 flex items-center gap-3">
              <a
                href="https://www.instagram.com/hotelparaiso_pontenova"
                target="_blank"
                rel="noopener noreferrer"
                className="flex h-9 w-9 items-center justify-center rounded-full border border-white/15 text-white/60 transition-colors hover:border-brand-gold hover:text-brand-gold"
              ...
              <a
                href="https://www.facebook.com/hotelparaiso.pontenova"
                target="_blank"
                rel="noopener noreferrer"
                className="flex h-9 w-9 items-center justify-center rounded-full border border-white/15 text-white/60 transition-colors hover:border-brand-gold hover:text-brand-gold"
                aria-label="Facebook"
